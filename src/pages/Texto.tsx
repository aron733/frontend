...
const styles = {
  container: { padding: '10px', maxWidth: '600px', width: '100%', margin: '0 auto' },
  headerListe: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' },
  ...
  searchBar: { display: 'flex', alignItems: 'center', gap: '10px', background: 'rgba(255,255,255,0.1)', borderRadius: '15px', padding: '10px 15px', marginBottom: '15px', border: '1px solid rgba(255,255,255,0.2)', color: '#aaa' },
  ...
  resultatsListe: { display: 'flex', flexDirection: 'column' as const, gap: '10px' },
  ...
  conversationsListe: { display: 'flex', flexDirection: 'column' as const, gap: '10px' },
  convItem: { display: 'flex', alignItems: 'center', gap: '15px', padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '15px', border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', textAlign: 'left' as const },
  ...
  convContainer: { maxWidth: '600px', width: '100%', height: 'calc(100vh - 100px)', minHeight: '350px', display: 'flex', flexDirection: 'column' as const, background: 'rgba(255,255,255,0.05)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)', overflow: 'hidden' },
  ...
  saisieArea: { display: 'flex', alignItems: 'center', gap: '6px', padding: '8px', background: '#111b21', borderTop: '1px solid #222d34', flexShrink: 0, position: 'sticky' as const, bottom: 0, zIndex: 10, minHeight: '55px' },
