...
const styles = {
  container: { padding: '20px', maxWidth: '500px', width: '100%' },
  ...
  messagesArea: { flex: 1, padding: '15px', overflowY: 'auto' as const, display: 'flex', flexDirection: 'column' as const, gap: '8px', background: '#0b141a', WebkitOverflowScrolling: 'touch' as any, overscrollBehavior: 'contain' },
  ...
  saisieArea: { display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 12px', background: '#111b21', borderTop: '1px solid #222d34', flexShrink: 0, position: 'sticky' as const, bottom: 0, zIndex: 10 },
