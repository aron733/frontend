...
const styles = {
  container: { padding: '0', maxWidth: '100%', width: '100%', minHeight: '100dvh', display: 'flex', flexDirection: 'column' as const, background: '#0b141a',  },
  ...
  convContainer: { width: '100%', minHeight: '100dvh', display: 'flex', flexDirection: 'column' as const, background: '#0b141a',  },
