...
const styles = {
  ...
  conversationsListe: { display: 'flex', flexDirection: 'column' as const, gap: '5px', flex: 1, overflowY: 'auto' as const, padding: '5px' },
  convItem: { display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 15px', background: 'transparent', border: 'none', borderBottom: '1px solid #1a2a33', cursor: 'pointer', textAlign: 'left' as const, width: '100%' },
  ...
  convContainer: { width: '100%', height: '100dvh', display: 'flex', flexDirection: 'column' as const, background: '#0b141a', overflow: 'hidden' },
  ...
  messagesArea: { flex: 1, padding: '10px 15px', overflowY: 'auto' as const, display: 'flex', flexDirection: 'column' as const, gap: '6px', background: '#0b141a', WebkitOverflowScrolling: 'touch' as any, overscrollBehavior: 'contain', scrollBehavior: 'smooth' as any },
  ...
  saisieArea: { display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 10px', background: '#111b21', borderTop: '1px solid #222d34', flexShrink: 0, minHeight: '55px', position: 'sticky' as const, bottom: 0, zIndex: 10 },
