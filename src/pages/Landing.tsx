  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <button 
          onClick={async () => {
            const url = 'https://api.vokyvo.com/oauth/google/';
            if (Capacitor.isNativePlatform()) {
        ...
        >
          ...
          {mode === 'inscription' ? "S'inscrire avec Google" : 'Continuer avec Google'}
        </button>
      ...
      <footer style={styles.footer}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '14px', marginTop: '14px' }}>
          ...
          <a href="https://apkpure.com/p/com.vokyvo.labs" target="_blank" aria-label="APKPure" style={{ color: '#555', transition: 'color 0.2s' }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path d="M11.6 0.5L1 21h4.5L12 8.2 18.5 21H23L12.4 0.5h-.8zm-2 9.7l1.6 3.2h-3.2l1.6-3.2z"/>
            </svg>
          </a>
        </div>
      </footer>
